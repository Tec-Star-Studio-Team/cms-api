...
public static class LanguageHelper
{
    private static readonly HashSet<string> ValidCodes = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "az", "ba", "be", "bg", "bi", "bm", "bn", "bo", "br", "bs", "ca",
        ...
        "mg", "mh", "mi", "mk", "ml", "mn", "mr", "ms", "mt", "my", "na",
        "nb", "nd", "ne", "ng", "nl", "nn", "no", "nr", "nv", "ny", "oc",
        "oj", "om", "or", "os", "pa", "pi", "pl", "ps", "pt", "qu", "rm",
    ...
    public static bool Exists(string code) => ValidCodes.Contains(code);
}
